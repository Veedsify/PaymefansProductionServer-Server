    ...
    static async allConversations(req, res) {
        ...
        try {
            ...
            if (cachedData) {
                ...
                return res.json({ messages: parsedData.messages, receiver: parsedData.receiver });
            }
            ...
            if (data) {
                ...
                const receiverId = participants.user_1 === user.user_id ? participants.user_2 : participants.user_1;
